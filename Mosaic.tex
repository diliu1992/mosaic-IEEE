...
\begin{abstract}
Orthoimage mosaicking is the process of combining multiple orthoimages with overlapping fields to produce a panorama. One of its key technologies is to determine the seamline for overlap of adjacent orhtoimages, which making the seamline hard to be seen. However, most of the existing mosaicking methods search seamline in the whole overlapping field, which is inefficient when the overlapping field is large with millions of pixels. Besides, most of the existing methods are based on the intensity difference of the overlapping areas, and few methods combine other auxilary information besides of intensity information to calculate the seamline. In this paper, we propose a method to search seamline within the buffer of image's overlapping field, and in the process of searching seamline, intensity information and elevation information of digital surface model (DSM) of image's overlapping field are comprehensively utilized. Firstly, for two images with effective overlapping range, we calculate the middle line of the overlap, and form a buffer along the middle line with a specific width. Secondly, according to the definition of energy function, we calculate the energy map of the buffer, and construct the network based on the energy map. Finally, we use the graph-cut algorithm to find the minimum cut for the network, and use the path across the minimum cut as the seamline of adjacent images. The proposed approach is tested on 69 orthoimages with ground sample distance of 0.2 m. Experimental results show that our method generates seamline which can effectively bypass the significant ground objects with very high efficiency.
\end{abstract}

% Note that keywords are not normally used for peerreview papers.
\begin{IEEEkeywords}
Graph-cut, mosaic, orthoimage, seamline.
\end{IEEEkeywords}
...
%2017/0326 加上了图割算法文献的引用{Boykov2004}
...
\begin{figure}[!t]
	\centering
	\subfigure[]{\resizebox*{2.5cm}{!}{\includegraphics{photomosaic-1}}}
    \subfigure[]{\resizebox*{2.5cm}{!}{\includegraphics{photomosaic-2}}}
    \subfigure[]{\resizebox*{2.5cm}{!}{\includegraphics{photomosaic-3}}}
...
\begin{figure}[!t]
    \centering
    \subfigure[]{\resizebox*{3cm}{3cm}{\includegraphics{seamline-details-comparison-1}}}
    \subfigure[]{\resizebox*{3cm}{3cm}{\includegraphics{seamline-details-comparison-2}}}
    \subfigure[]{\resizebox*{3cm}{3cm}{\includegraphics{seamline-details-comparison-3}}}
    \subfigure[]{\resizebox*{3cm}{3cm}{\includegraphics{seamline-details-comparison-4}}}
...
\begin{figure}[!t]
    \centering
    \subfigure[]{\resizebox*{8cm}{!}{\includegraphics{efficiency-compare}}}
    \subfigure[]{\resizebox*{8cm}{!}{\includegraphics{passedthrough-compare}}}
